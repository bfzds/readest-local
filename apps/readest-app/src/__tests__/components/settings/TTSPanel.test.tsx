...
describe('TTSPanel inline reading annotations', () => {
  ...
  // Local adaptation of #6057: the switch is shown for every UI language, not
  // gated to Japanese like upstream, so the reading preference stays reachable
  // in the zh-CN/zh-TW/en builds this branch maintains.
  it('shows the switch regardless of the UI language', () => {
