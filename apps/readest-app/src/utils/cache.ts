 ...
 * progress in a dir no saved row owns. (Upstream also keeps the paired
 * audiobook copies under `audiobook/`; this branch has no audiobook module.)
 */
 ...
 * (a book file a cloud tombstone never removed, a feed's article cache). Root-level library metadata is never an orphan.
